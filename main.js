...
printEvents([[5, 2, 13], [17, 4, 102, 3000]]);
...
challenge88.push(2)
challenge88.push(3)
challenge88.unshift(4);
challenge88.unshift(5);

for (let i = 0; i < challenge88.length; i++) {
  const value = challenge88[i];
  console.log(value);
}
